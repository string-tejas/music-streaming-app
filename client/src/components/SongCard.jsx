...
const SongCard = ({song}) => {
  ...
  return (
    <div className='card-main-div'>
        <div class="card " >
  <img className="card-img-top song-img" src={song.imageURL}alt="Card image cap"/>
  <div className="card-body">
    <center><h5 class="text-base text-headingColor font-semibold  items-center">{song.name}</h5></center>
